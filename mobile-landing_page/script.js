...
function redirectToMobilePage() {
    ...
    var minWidthForRedirect = 1024; // Example: redirect for devices smaller than iPad width

    // Check the device screen width
    var screenWidth = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth;

    // Redirect if the screen width is less than the defined maximum width
    if (screenWidth > minWidthForRedirect) {
        window.location.href = "../landing_page/index.html"; // Replace with your desired URL
    }
}
